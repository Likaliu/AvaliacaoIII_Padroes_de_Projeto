...
public class ExportadorXmlVisitor implements PlaylistVisitor {
    ...
    public void visit(Serie serie) {
        // Apenas abre e fecha a tag. A cascata do accept() nativo na série cuidará dos episódios internamente.
    ...
    public void visit(Pacote pacote) {
        // Apenas abre e fecha a tag. A cascata do accept() nativo no pacote cuidará dos subitens internamente.
